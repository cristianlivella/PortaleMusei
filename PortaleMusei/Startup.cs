...
namespace PortaleMusei
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PortaleMuseiContext>(options => options.UseSqlite(Configuration.GetConnectionString("PortaleMuseiContext")));
        }
